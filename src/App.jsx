...
const RECOVERY_RECORDS = {
  moves: [
    { date: "2026-08-17", mobId: "c70f767mswmlw2v", toPaddock: "Billabong (House / Mootinara)", id: "w6q8k5cmsxovh49", createdAt: 1786998678633, fromPaddock: "Inbox", mobName: "Black tag · Steers", property: "Buckanbe", merged: true, head: 16, mobSnapshot: { id: "c70f767mswmlw2v", property: "Buckanbe", paddock: "Inbox", species: "Cattle", cls: "Steers", head: 16, breed: "", tag: "Black tag", status: "", origin: "", name: "", notes: "", createdAt: 1786934406055 } },
    { date: "2026-08-24", mobId: "kscb7l0mrn4whw6", toPaddock: "Saddling", id: "91lq9olmt6mfhpw", createdAt: 1787538769268, fromPaddock: "Eagle", mobName: "Ultra · M/A · Breeding ewes · Late", property: "Minto" },
    { date: "2026-08-24", mobId: "f0d5wrlmrn4whw6", toPaddock: "Bullock", id: "2qq7fmzmt6milzd", createdAt: 1787538914761, fromPaddock: "Shady", mobName: "Angus · White tag · Stud Angus heifers", property: "Minto" },
    { date: "2026-08-24", mobId: "58h5birmrn4whw6", head: "157", toPaddock: "Racecourse", id: "buwc4kjmt6mnj3y", createdAt: 1787539144318, fromPaddock: "Spring", mobName: "Dorper · White tag · Weaner lambs", property: "Minto", split: true },
    { date: "2026-08-24", mobId: "58h5birmrn4whw6", head: "184", toPaddock: "Racecourse", id: "jcxbbo8mt6mp6bo", createdAt: 1787539221060, fromPaddock: "Spring", mobName: "Dorper · White tag · Weaner lambs", property: "Minto", split: true },
    { date: "2026-08-24", mobId: "gh3dh9mmrn4whw6", toPaddock: "Bullock", id: "sgtt1smmt6mr5hb", createdAt: 1787539313279, fromPaddock: "Shady", mobName: "Kids' cattle", property: "Minto" },
    { date: "2026-08-24", mobId: "fjqhmeomswi3nab", toPaddock: "Bullock", id: "bhq82zjmt6mrat4", createdAt: 1787539320184, fromPaddock: "Shady", mobName: "Black + Sky blue tag · Heifers · PTE · ex Buckanbe", property: "Minto" },
    { date: "2026-08-24", mobId: "stnwww6msfog50y", toPaddock: "Bullock", id: "z2fs082mt6ms3wc", createdAt: 1787539357884, fromPaddock: "Spring", mobName: "Angus · White tag · Heifers · Heifers", property: "Minto" },
    { date: "2026-08-24", mobId: "g2bpzcfmsfod0be", toPaddock: "Bullock", id: "fhwjmaemt6ms9v5", createdAt: 1787539365617, fromPaddock: "Spring", mobName: "Angus · White tag · Steers", property: "Minto" },
    { date: "2026-08-24", mobId: "71v9ul9mswn00ca", toPaddock: "Bullock", id: "q911lkumt6mt92t", createdAt: 1787539411253, fromPaddock: "Swamp", mobName: "Angus · Orange tag · Calves · MS", property: "Minto" },
    { date: "2026-08-24", mobId: "0pyxq4wmss7hly5", toPaddock: "Bullock", id: "iecp9wpmt6mtrj4", createdAt: 1787539435168, fromPaddock: "Swamp", mobName: "Angus · Orange tag · Calves · MS", property: "Minto", merged: true, head: 62, mobSnapshot: { id: "0pyxq4wmss7hly5", property: "Minto", paddock: "Swamp", species: "Cattle", cls: "Calves", head: 62, breed: "Angus", tag: "Orange tag", status: "MS", origin: "", name: "", notes: "", createdAt: 1786667147357 } },
    { date: "2026-08-24", mobId: "t3h1fiqmrn4whw6", toPaddock: "Back", notes: "", id: "7halu4kmtavf8zx", createdAt: 1787795739213, fromPaddock: "Delta", mobName: "White tag · Stud ultra ewe lambs", property: "Minto" },
    { date: "2026-08-27", mobId: "h15r34xmrn4whw6", toPaddock: "Middle Back", id: "hxms5tpmtavvl1t", createdAt: 1787796501329, fromPaddock: "Back", mobName: "Stud Angus cows", property: "Minto" },
    { date: "2026-08-27", mobId: "gh3dh9mmrn4whw6", toPaddock: "Bullock", id: "zamj6dimtaw1iu7", createdAt: 1787796778399, fromPaddock: "Shady", mobName: "Kids' cattle", property: "Minto" },
    { date: "2026-08-28", mobId: "f0d5wrlmrn4whw6", head: "29", toPaddock: "Bullock", id: "r3s8ek6mtcb0sgx", createdAt: 1787882404641, fromPaddock: "Delta", mobName: "Stud Angus heifers", property: "Minto", split: true },
  ...
  maint: [
    ...
    { date: "2026-08-18", category: "Infrastructure", property: "Minto", propertyElement: "Fence", work: "Strainers [reconstructed from Activity log only — no fuller record survived in any backup]", id: "qbl9727msyay8fu", createdAt: 1787047726667 },
  ],
  weaning: [
  ...
  // Third pass — a different bug from the two above (which lost individual
  // records over 5-28 Aug). This one wiped the WHOLE health array back to its
  // single original baseline entry in one hit — the daily backups show it sat
  // untouched at 21 records from 28 Aug through 31 Aug, then dropped to just
  // the baseline record with a write timestamped 1 Sep. That's the same class
  // of "a flaky load silently saves baseline over real data" bug fixed by the
  // fromBaseline change above (this fix landed 3 Sep, after this particular
  // wipe already happened, so it doesn't undo it — just stops it recurring).
  // All 20 records below except the still-present baseline one; sourced from
  // the 28-31 Aug backups, which agree byte-for-byte.
  health: [
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"86a8wz5mtcc1ju9","id":"cyc08gkmtcett93","createdAt":1787888797527,"mobName":"Angus · Blue tag · Bulls · Bulls","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"d5jox13mtcc0evj","id":"vj1ztvmmtcett9b","createdAt":1787888797535,"mobName":"Angus · Light green tag · Bulls · Stud","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"qfc2176mtcbgiam","id":"qctaf3dmtcett9f","createdAt":1787888797539,"mobName":"Angus · White tag · Heifers","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"sg45rlemtcc5rmt","id":"m4e5ahqmtcett96","createdAt":1787888797530,"mobName":"Angus · White tag · Bulls","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"gh3dh9mmrn4whw6","id":"rx6kqltmtcett9h","createdAt":1787888797541,"mobName":"Kids' cattle","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"2tjwtfemtcb0sgy","id":"uji4c0vmtcett9d","createdAt":1787888797537,"mobName":"White tag · Stud Angus heifers","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"arwt2o1mtccaee2","id":"w039iz4mtcett99","createdAt":1787888797533,"mobName":"Angus · Black + Blue tag · Steers · Stag","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-03","product":"Baymec & Tas Vax","batch":"E266437A - Exp 08.29","dose":"20-40ml","whp":"42","esi":"42","treatedBy":"Ben Judd Kate","notes":"Pink eye treated - No WHP on Tas VAX","mobId":"ajs7vcemrn4whw6","id":"tbtdhojmtcett8z","createdAt":1787888797523,"mobName":"Angus · White tag · Steers","property":"Minto","whpClear":"2026-09-14","esiClear":"2026-09-14"},
    {"date":"2026-08-17","mobId":"dojv26umtcc7bxe","product":"Baymec and Tas VAX","batch":"E266437A","whp":"42","esi":"42","notes":"Baymec WHP no WHP on Tas Vax","id":"0j43b59mtcd27tp","createdAt":1787885830429,"mobName":"Angus · Black tag · Steers · ex Buckanbe","property":"Minto","whpClear":"2026-09-28","esiClear":"2026-09-28"},
    {"date":"2026-08-17","mobId":"vxziny6mtcaxo6t","product":"Baymec & Tas VAX","whp":"42","esi":"42","batch":"E266437A","treatedBy":"Ben Judd Kate","id":"m54x84amtcd010z","createdAt":1787885728307,"mobName":"Angus · White + Orange tag · Weaner M/S · MS · ex Buckanbe","property":"Minto","whpClear":"2026-09-28","esiClear":"2026-09-28"},
    {"date":"2026-08-24","mobId":"61xwi7ymtav8nmm","product":"Foot Bath ","id":"pkaq239mtccy4gz","createdAt":1787885639459,"mobName":"Ultra · Orange tag · Stud ultra ram lambs","property":"Minto"},
    {"date":"2026-08-28","mobId":"0dtmafgmtav8u7h","product":"Foot Bath","id":"fzjw0zamtccxjke","createdAt":1787885612366,"mobName":"Ultra · Orange tag · Stud ultra ewe lambs","property":"Minto"},
    {"date":"2026-08-24","mobId":"7ugxsyimrn4whw6","product":"Foot Bath","id":"d6ypudgmtccx7ha","createdAt":1787885596702,"mobName":"Ultra · Orange tag · Rams · Rams","property":"Minto"},
    {"date":"2026-08-24","mobId":"t3h1fiqmrn4whw6","product":"FootBath ","id":"5a6l56nmtccw8qn","createdAt":1787885551679,"mobName":"White tag · Stud ultra ewe lambs","property":"Minto"},
    {"date":"2026-08-24","mobId":"7ugxsyimrn4whw6","product":"Q Drench ","dose":"20","whp":"28","esi":"28","treatedBy":"Ben Judd Kate","id":"5d1eq4cmtccv95r","createdAt":1787885505567,"mobName":"Ultra · Orange tag · Rams · Rams","property":"Minto","whpClear":"2026-09-21","esiClear":"2026-09-21"},
    {"date":"2026-08-24","mobId":"wmmizo9mrn4whw6","product":"Q Drench","dose":"15","whp":"28","esi":"28","treatedBy":"Ben Judd Kate","id":"vymk5a4mtcctyd9","createdAt":1787885444925,"mobName":"Stud ultra ewes","property":"Minto","whpClear":"2026-09-21","esiClear":"2026-09-21"},
    {"date":"2026-08-24","mobId":"61xwi7ymtav8nmm","product":"Q Drench","dose":"10","whp":"28","esi":"28","treatedBy":"Ben Judd Kate","id":"n2fwpl0mtcctb0f","createdAt":1787885414655,"mobName":"Ultra · Orange tag · Stud ultra ram lambs","property":"Minto","whpClear":"2026-09-21","esiClear":"2026-09-21"},
...
export default function App({ onSignOut, userEmail, userName } = {}) {
  ...
  // ONE-TIME: applies RECOVERY_RECORDS (see its definition for what/why).
  // Skips anything already present, so it's safe to press more than once —
  // e.g. if only some of the writes land before a connection hiccup.
  const runOneTimeRecovery = () => {
    let restored = 0;
    Object.entries(RECOVERY_RECORDS).forEach(([typeKey, records]) => {
      const existingIds = new Set((data[typeKey] || []).map((r) => r.id));
      const toAdd = records.filter((r) => !existingIds.has(r.id));
      if (!toAdd.length) return;
      setAndSave(typeKey, [...toAdd, ...(data[typeKey] || [])]);
      toAdd.forEach((r) => {
        try {
          const s = summarise(typeKey, r);
          logAudit(
            "Restored (one-time recovery)",
            (RECORD_TYPES[typeKey]?.single || typeKey) + " · " + [s.title, s.sub].filter(Boolean).join(" · "),
            typeKey,
            r.id
          );
        } catch {}
    ...
    flash(restored ? `Restored ${restored} record(s)` : "Nothing left to restore — already applied");
  };
  const recoveryTotal = Object.values(RECOVERY_RECORDS).reduce((a, arr) => a + arr.length, 0);
  const recoveryRemaining = Object.entries(RECOVERY_RECORDS).reduce((a, [typeKey, records]) => {
    const existingIds = new Set((data[typeKey] || []).map((r) => r.id));
  ...
  const pastureCommentary = async (prop) => {
    ...
    try {
      // Routed through a Netlify Function (holds the real API key server-side —
      // see netlify/functions/pasture-commentary.js) rather than calling
      // api.anthropic.com straight from the browser, which only ever worked
      // inside the claude.ai artifact sandbox that injected auth for that
      // domain, not on the live hosted site.
          ...
          <>
            ...
            {recoveryRemaining > 0 && (
              <section className="card">
                ...
                <p className="note">
                  Restores {recoveryRemaining} of {recoveryTotal} records lost to the save bugs from 5 August – 1
                  September (paddock moves, sales & transfers, adjustments, weaning, marking, preg testing,
                  maintenance jobs, health treatments) using their original data from the daily backups. This
                  restores the paper trail only — it does not change today's mob head counts or paddocks, since
                  those have had other legitimate activity since and need the physical stocktake to correct, not
                  a blind replay. Safe to press more than once; already-restored records are skipped.
                </p>
                <button
